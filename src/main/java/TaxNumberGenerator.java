...
public class TaxNumberGenerator {
    ...
    public static String getTransactionValueWithTax(String transactionAmmount, String taxValue) {
        ...
        String transactionCostWithTaxStr = String.format("%.2f", transactionCostWithTax);
        return (transactionCostWithTaxStr.replace(",","."));
    }
    ...
    public static String getValueAddedTax(String transactionAmmount) {
        ...
        String valueAddedTaxStr = String.format("%.2f", valueAddedTax);
        return (valueAddedTaxStr.replace(",","."));
    }
    ...
    public static void sendCopyOfTransaction(FileWriter transactionsWithErrorsFileWriter, TransactionRecord transaction) throws IOException {
        ...
        if (indexOfChangingParameter == 2) {
            ...
            transactionAmmountWithTax = String.valueOf(transactionValue).replace(",",".");
    ...
    String transactionsFilePath = "/home/pavel/IdeaProjects/taxes-generation/src/com/company/transactions.csv";
    String transactionsWithErrorsFilePath = "/home/pavel/IdeaProjects/taxes-generation/src/com/company/transactionsWithErrors.csv";
    ...
    final int AMMOUNT_OF_TRANSACTIONS = 1000;
